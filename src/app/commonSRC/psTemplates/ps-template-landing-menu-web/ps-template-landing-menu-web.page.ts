...
@Component({
  selector: 'ps-template-landing-menu-web',
  templateUrl: './ps-template-landing-menu-web.page.html'
})
export class PsTemplateLandingMenuWebPage extends PsTemplateLandingMainPage implements OnInit {
  ...
  @Input() options: IOptionsTemplateLandingMain;
  ...
  ngOnInit() {
    this.init();
    this.options.triggerMenuFlip = (component) => {
